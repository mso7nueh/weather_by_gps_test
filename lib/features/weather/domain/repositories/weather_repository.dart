...
abstract class WeatherRepository {
  Future<Either<Failure, CurrentTempEntity>> getCurrentTemp(String latitude, String longitude);

  Future<Either<Failure, List<FutureTempEntity>>> getFutureTemp(String latitude, String longitude);
}
