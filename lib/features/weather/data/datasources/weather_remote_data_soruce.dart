...
abstract class WeatherRemoteDataSource {
  Future<CurrentTempModel> getCurrentTemp();

  Future<List<FutureTempModel>> getFutureTemp();
}
...
class WeatherRemoteDataSourceImpl extends WeatherRemoteDataSource {
  ...
  @override
  Future<CurrentTempModel> getCurrentTemp() async {
  ...
  @override
  Future<List<FutureTempModel>> getFutureTemp() async {
